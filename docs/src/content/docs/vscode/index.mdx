...
| [1. MCP with VS Code][ex1] | External Tools | Use MCP to interact with GitHub from your IDE |
| [2. Custom instructions][ex2] | Context | Add and verify custom instructions in VS Code |
