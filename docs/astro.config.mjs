      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: '3. Custom instructions hands-on', link: '/cli/3-custom-instructions/' },
            { label: '4. MCP with CLI', link: '/cli/4-mcp/' },
            { label: '5. Generating code', link: '/cli/5-generating-code/' },
            { label: '6. Agent skills', link: '/cli/6-agent-skills/' },
            { label: '7. Custom agents', link: '/cli/7-custom-agents/' },
            { label: '8. Slash commands', link: '/cli/8-slash-commands/' },
