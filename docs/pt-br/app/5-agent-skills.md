...
Os arquivos da skill acompanharão a filtragem, o perfil de QA e os testes associados no PR do recurso na Lição 8. Continue nesta mesma sessão com a [Lição 6 - Validar a funcionalidade com o MCP do Playwright][next-lesson].
