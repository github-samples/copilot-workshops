...
**GitHub Copilot 앱**은 Copilot CLI를 기반으로 구축된 데스크톱 애플리케이션입니다. 앱의 격리된 세션과 **Agent Merge**를 사용하여 동일한 설정 과정과 아홉 개의 핵심 모듈에서 별점, 지침, 필터링, 스킬, MCP, QA, 기능 PR 워크플로를 진행합니다. 네 번째 끌어오기 요청 마일스톤으로 리포지토리에 저장하는 캔버스를 만들고 병합한 다음 마무리합니다.
