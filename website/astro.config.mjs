      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: '4. Build filtering with Plan and Autopilot', link: '/app/4-build-filtering/' },
            { label: '5. Create and use a quality-checks skill', link: '/app/5-agent-skills/' },
            { label: '6. Validate with Playwright MCP', link: '/app/6-mcp-playwright/' },
            { label: '7. Create and use a QA agent', link: '/app/7-qa-agent/' },
