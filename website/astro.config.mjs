          ...
          items: [
            { label: 'Overview', link: '/first-steps/' },
            {
              ...
              items: [
                ...
                { label: '3. Publish the project', link: '/first-steps/copilot-app/3-publish/' },
                { label: '4. Issues and sessions', link: '/first-steps/copilot-app/4-issues-and-sessions/' },
                { label: '5. Complete the review loop', link: '/first-steps/copilot-app/5-review/' },
                { label: '6. Automate issue triage', link: '/first-steps/copilot-app/6-automations/' },
                { label: '7. Explore a Canvas', link: '/first-steps/copilot-app/7-canvas/' },
                { label: '8. Review and next steps', link: '/first-steps/copilot-app/8-review/' },
              ],
            },
          ],
        },
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: '1. Install Copilot CLI', link: '/real-world-development/cli/1-install-copilot-cli/' },
                { label: '2. Custom instructions', link: '/real-world-development/cli/2-custom-instructions/' },
                { label: '3. Generating code', link: '/real-world-development/cli/3-generating-code/' },
                { label: '4. Testing with Playwright MCP', link: '/real-world-development/cli/4-mcp/' },
            ...
            },
            {
              ...
              items: [
                ...
                { label: '2. Running your first agent session', link: '/real-world-development/app/2-add-star-rating/' },
                { label: '3. Guiding Copilot with custom instructions', link: '/real-world-development/app/3-custom-instructions/' },
                { label: '4. Building a feature with Autopilot', link: '/real-world-development/app/4-build-filtering/' },
                { label: '5. Testing with Playwright MCP', link: '/real-world-development/app/5-mcp-playwright/' },
                { label: '6. Merging with Agent Merge', link: '/real-world-development/app/6-agent-merge/' },
                { label: '7. Planning with canvases', link: '/real-world-development/app/7-canvases/' },
                { label: '9. Review', link: '/real-world-development/app/9-review/' },
                {
                  label: 'Optional: Incorporate Foundry',
                  translations: {
                    'es-ES': 'Opcional: Incorporar Foundry',
