<!--
  ...
  Source: docs/src/content/docs/vscode/5-custom-agents.mdx
  Run `python scripts/render-markdown.py` to regenerate.
-->

# Exercise 5 - Custom agents

⬅️ **Previous lesson:** [Exercise 4 - GitHub Copilot cloud agent](4-cloud-agent.md)
...
⬅️ **Previous lesson:** [Exercise 4 - GitHub Copilot cloud agent](4-cloud-agent.md)
➡️ **Next lesson:** [Exercise 6 - Monitoring and managing agents](6-managing-agents.md)
