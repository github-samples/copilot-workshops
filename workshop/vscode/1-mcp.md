<!--
  ...
  Source: docs/src/content/docs/vscode/1-mcp.mdx
...
3. Type or paste the following prompt to create the issues you'll be working on in the lab:
    ...
    2. Update our repository coding standards (including rules about Python formatting and docstrings) in our instructions file
