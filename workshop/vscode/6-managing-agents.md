<!--
  ...
  Source: docs/src/content/docs/vscode/6-managing-agents.mdx
  Run `python scripts/render-markdown.py` to regenerate.
-->

# Exercise 6 - Monitoring and managing agents

⬅️ **Previous lesson:** [Exercise 5 - Custom agents](5-custom-agents.md)
...
⬅️ **Previous lesson:** [Exercise 5 - Custom agents](5-custom-agents.md)
➡️ **Next lesson:** [Exercise 7: Iterating on GitHub Copilot's work](7-iterating.md)
