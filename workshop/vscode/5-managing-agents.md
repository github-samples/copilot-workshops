<!--
  ...
  Source: docs/src/content/docs/vscode/5-managing-agents.mdx
  Run `python scripts/render-markdown.py` to regenerate.
-->

# Exercise 5 - Monitoring and managing agents
...
2. Review the full list of changed files. You should see updates to the Svelte components, styles, and any related tests.
...
[previous-lesson]: 4-custom-agents.md
[next-lesson]: 6-iterating.md
