<!--
  ...
  Source: docs/src/content/docs/vscode/6-iterating.mdx
  Run `python scripts/render-markdown.py` to regenerate.
-->

# Exercise 6 - Iterating on GitHub Copilot's work
...
- 💻 **[CLI path](../cli/README.md)** — work similar flows from your terminal with Copilot CLI: plan mode, agent skills, custom agents, and slash commands like `/share`, `/context`, and `/delegate`.
- ☁️ **[Cloud agent path](../cloud/README.md)** — focus on assigning issues to cloud agent, monitoring sessions through the agents page, and iterating asynchronously on pull requests.
...
[previous-lesson]: 5-managing-agents.md
[exercise-4]: 4-custom-agents.md
[exercise-5]: 5-managing-agents.md
