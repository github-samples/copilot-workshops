<!--
  ...
  Source: docs/src/content/docs/shared/0-prereqs.mdx
...
>
> If you are running the workshop locally, rather than creating a codespace, clone the newly created repository. Then open the cloned repository in VS Code, which you will use in place of Codespaces.
...
[next-vscode]: ../vscode/1-custom-instructions.md
[next-cli]: ../cli/1-install-copilot-cli.md
[next-cloud]: ../cloud/1-custom-instructions.md
