<!--
  ...
  Source: docs/src/content/docs/shared/cloud-agent/cloud-agent.mdx
...
- 🖥️ **VS Code path** → [Exercise 5: Custom agents](../../vscode/5-custom-agents.md)
- ☁️ **Cloud path** → [Exercise 3: Custom agents](../../cloud/3-custom-agents.md)
