...
If you'd like to explore more of the GitHub Copilot ecosystem, check out the [VS Code path](../vscode/README.md) or the [Cloud/Cloud Agent path](../cloud/README.md).
