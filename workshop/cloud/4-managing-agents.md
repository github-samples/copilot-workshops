<!--
  ...
  Source: docs/src/content/docs/cloud/4-managing-agents.mdx
  Run `python scripts/render-markdown.py` to regenerate.
-->

# Exercise 4 - Monitoring and managing agents

⬅️ **Previous lesson:** [Exercise 3 - Custom agents](3-custom-agents.md)
...
3. In the **Steer active session while Copilot is working** dialog, add the following prompt:
    ...
    ![Screenshot of the cloud agent task in the agents page with the steer active session while copilot is working dialogue highlighted](../images/ex6-steer-cloud-agent-task.png)
...
- explored Copilot HQ and the agents page to monitor cloud agent tasks.
- redirected an in-flight session to request additional functionality.

With Copilot completing its work on the accessibility features, we can now turn our attention to **iterating on the pull requests Copilot created**. Mission control provides visibility into agent work and enables dynamic collaboration with cloud agents as they work on tasks.
...
[agents-page]: https://github.blog/changelog/2025-10-28-a-agents-page-to-assign-steer-and-track-copilot-cloud-agent-tasks
[custom-agents]: https://docs.github.com/copilot/concepts/agents/cloud-agent/about-custom-agents

---

⬅️ **Previous lesson:** [Exercise 3 - Custom agents](3-custom-agents.md)
➡️ **Next lesson:** [Exercise 5: Iterating on GitHub Copilot's work](5-iterating.md)
