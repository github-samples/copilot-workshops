...
3. In the **Steer active session while Copilot is working** dialog, add the following prompt:
    ...
    ![Screenshot of the cloud agent task in the agents page with the steer active session while copilot is working dialog highlighted](../images/ex6-steer-cloud-agent-task.png)
...
[previous-lesson]: 3-custom-agents.md
[next-lesson]: 5-iterating.md
