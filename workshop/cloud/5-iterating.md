<!--
  ...
  Source: docs/src/content/docs/cloud/5-iterating.mdx
...
- 💻 **[CLI path](../cli/README.md)** — work the same flows from your terminal with Copilot CLI: plan mode, agent skills, custom agents, and slash commands like `/delegate` to bridge back to the cloud agent you used here.
