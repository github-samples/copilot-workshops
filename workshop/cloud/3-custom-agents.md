<!--
  ...
  Source: workshop-content/cloud/3-custom-agents.mdx
  Run `python scripts/render-markdown.py` to regenerate.
-->

# Exercise 3 - Custom agents

⬅️ **Previous lesson:** [Exercise 2 - GitHub Copilot cloud agent](2-cloud-agent.md)
...
⬅️ **Previous lesson:** [Exercise 2 - GitHub Copilot cloud agent](2-cloud-agent.md)
➡️ **Next lesson:** [Exercise 4 - Monitoring and managing agents](4-managing-agents.md)
