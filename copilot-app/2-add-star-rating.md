...
3. Ensure `tailspin-toys` is selected for the repo.
   ...
   ![The GitHub Copilot app prompt box with the repository selector set to tailspin-toys and the model selector shown beneath the prompt](images/app-2-start-session.png)
