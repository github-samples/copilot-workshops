...
3. Select **Agent merge** to enable agent merge.
   ...
   ![The Create PR dropdown in the GitHub Copilot app expanded, with an arrow pointing to the Agent merge option](images/app-enable-agent-merge.png)
...
6. Allow agent merge to merge the pull request by selecting the dropdown next to **Agent merge** then **Merge pull request**.
   ...
   ![The Agent merge dropdown showing the agent's allowed actions — Address reviews, Fix CI failures, Resolve conflicts — with an arrow pointing to Merge pull request](images/app-agent-merge-merge.png)
