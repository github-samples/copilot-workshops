...
2. **VS Code**: [MCP](vscode/3-mcp/) → [Agent mode](vscode/4-agent-mode/)
3. **CLI**: [Install CLI](cli/2-install-copilot-cli/) → [MCP](cli/3-mcp/) → [Generating code](cli/4-generating-code/) → [Agent skills](cli/5-agent-skills/) → [Slash commands](cli/7-slash-commands/)
