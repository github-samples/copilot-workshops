...
With cloud agent working diligently in the background, you can now turn your attention to your next lesson, [creating and using custom agents][next-lesson]. [Copilot cloud agent can also use MCP servers][cloud-agent-mcp], and has custom instructions available to it, which you explored in earlier modules.
