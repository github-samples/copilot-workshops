---
title: "Monitoring and managing agents"
---
...
- 🖥️ **VS Code path** → [Exercise 7: Iterating on Copilot's work](../../../vscode/8-iterating/)
- ☁️ **Cloud path** → [Exercise 5: Iterating on Copilot's work](../../../cloud/5-iterating/)
