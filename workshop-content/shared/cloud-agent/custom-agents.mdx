...
import AccessibilityScenario from '../../_partials/section-accessibility-scenario.mdx';
...
- 🖥️ **VS Code path** → [Exercise 6: Monitoring and managing agents](../../../vscode/6-managing-agents/)
- ☁️ **Cloud path** → [Exercise 4: Monitoring and managing agents](../../../cloud/4-managing-agents/)
